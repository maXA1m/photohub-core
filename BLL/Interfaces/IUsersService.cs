...
namespace PhotoHub.BLL.Interfaces
{
    public interface IUsersService : IDisposable, IReturnUser
    {
        ...
        void Edit(string userName, string realName, string phoneNumber, string email, string about, string webSite);
        Task EditAsync(string userName, string realName, string phoneNumber, string email, string about, string webSite);
    }
}
